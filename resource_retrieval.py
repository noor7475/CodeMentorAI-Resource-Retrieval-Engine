...
YOUTUBE_API_KEYS = [
    "AIzaSyAQ_ZKT-Ey23RrOvBulsRp_mE-rttJPR6U",
    "AIzaSyDL0pT5O1W2l2Ip0jq3yUmqQCBNzH6xL-Q",
    "AIzaSyC7JxgxVmU1fgTA63JMpSSDaI6ODfwV49s"
]
...
def is_valid_result(prog_lang, title, description):
    ...
    """
    # 1. Check for the programming language (your existing logic)
